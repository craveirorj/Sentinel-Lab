...
[Switch Hisource Hi-S21-8G]
    │
[Mini PC — Proxmox VE — 192.168.50.100]
    │
    ├── LAN Principal (192.168.50.0/24)
    ...
    │
    └── Rede Isolada Lab (10.10.99.0/24)
        ├── Metasploitable 2  (10.10.99.11)
        ├── Kioptrix          (10.10.99.10)
        └── DVWA              (10.10.99.4)
```
---
🔄 Fluxo Blue Team
...
VM	IP	Descrição
Metasploitable 2	10.10.99.11	Alvo multi-serviço vulnerável
Kioptrix	10.10.99.10	Máquina CTF-style
DVWA	10.10.99.4	Aplicação web vulnerável
Kali Linux	192.168.50.102	Máquina de ataque (dual NIC)
---
🤖 SENTINEL API
...
curl -X POST http://192.168.50.101:8000/analyst \
  -H 'Content-Type: application/json' \
  -d '{"query": "ET SCAN Nmap SYN Scan detectado de 10.10.99.50"}'

# Gerar relatório de incidente
curl -X POST http://192.168.50.101:8000/report \
  -H 'Content-Type: application/json' \
  -d '{}' -o relatorio.pdf
```
---
...
```
1. Configurar Switch (IP 192.168.50.2)
...
Proxmox VE	https://192.168.50.100:8006	root / [instalação]
Wazuh Dashboard	https://192.168.50.106	admin / [installer]
SENTINEL API	http://192.168.50.101:8000	—
AdGuard Home	http://192.168.50.108:3000	admin / [instalação]
...
👤 Autor
Ricardo Craveiro  
github.com/craveirorj  
linkedin.com/in/ricardo-craveiro-751512150
---
⚠️ Aviso
